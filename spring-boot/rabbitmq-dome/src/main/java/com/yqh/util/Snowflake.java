...
/**
 * @author yangq
 * Create time in 2019-08-28 14:29
 */
public class Snowflake {
     ...
     */
    private final static long maxDatacenterId = -1L ^ (-1L << datacenterIdBits); // 2^5-1
    private final static long maxWorkerId = -1L ^ (-1L << workerIdBits); // 2^5-1
     ...
     */
    private final static long epoch = 1451606400000L;
